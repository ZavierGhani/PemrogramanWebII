...
<head>
    ...
    <title><?= $buku ? "Ubah Buku" : "Tambah Buku" ?> — Pustaka</title>
...
<div class="main">
    <header class="topbar">
        <div class="topbar-left">
            <div class="page-title"><?= $buku ? "Ubah data buku" : "Tambah buku baru" ?></div>
            <div class="page-sub">Koleksi buku › <?= $buku ? "ubah" : "tambah" ?></div>
        </div>
    ...
    <main class="content">
        <div class="form-card">
            ...
            <div class="form-header">
                <div class="form-icon">
                    <i class="ti ti-<?= $buku ? "edit" : "book-plus" ?>"></i>
                </div>
                <h2><?= $buku ? "Ubah Data Buku" : "Tambah Data Buku" ?></h2>
                <p><?= $buku ? "Perbarui informasi buku yang sudah ada." : "Isi detail buku yang ingin ditambahkan ke koleksi." ?></p>
            </div>
            ...
            <form method="POST" action="FormBuku.php<?= $id ? '?id=' . $id : '' ?>">
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" name="judul"
                               value="<?= $buku ? htmlspecialchars($buku["judul_buku"]) : "" ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" name="penulis"
                               value="<?= $buku ? htmlspecialchars($buku["penulis"]) : "" ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" name="penerbit"
                               value="<?= $buku ? htmlspecialchars($buku["penerbit"]) : "" ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="number" name="tahun"
                               value="<?= $buku ? htmlspecialchars($buku["tahun_terbit"]) : "" ?>"
                ...
                <button type="submit" class="btn-submit">
                    <i class="ti ti-<?= $buku ? "device-floppy" : "plus" ?>"></i>
                    <?= $buku ? "Simpan Perubahan" : "Tambah Buku" ?>
                </button>
            </form>
